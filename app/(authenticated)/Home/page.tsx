...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      <p className="text-base sm:text-lg lg:text-xl text-gray-700 mb-8 text-center max-w-xl">
      ...
      <div className="w-full max-w-2xl bg-white rounded-xl shadow p-6 mt-4 border border-orange-50">
